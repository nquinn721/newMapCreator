...
/******/ 	// eslint-disable-next-line no-unused-vars
/******/ 	var hotCurrentHash = "48e8facff1d292a1fdfe";
...
/******/ 	return hotCreateRequire("./client/public/js/index.js")(__webpack_require__.s = "./client/public/js/index.js");
/******/ })
/************************************************************************/
/******/ ({
...
/***/ "./client/public/js/editor/main.js":
/*!*****************************************!*\
  !*** ./client/public/js/editor/main.js ***!
  \*****************************************/
/*! no exports provided */
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _project__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./project */ \"./client/public/js/editor/project.js\");\n\n\n\nvar root = _project__WEBPACK_IMPORTED_MODULE_0__[\"default\"].create();\nvar layer1 = _project__WEBPACK_IMPORTED_MODULE_0__[\"default\"].create();\n// const img = layer1.addImage('box.jpg', 100, 100);\n\n\n//# sourceURL=webpack:///./client/public/js/editor/main.js?");
...
/***/ "./client/public/js/editor/project.js":
/*!********************************************!*\
  !*** ./client/public/js/editor/project.js ***!
  \********************************************/
/*! exports provided: default */
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _editor_main__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./editor/main */ \"./client/public/js/editor/main.js\");\n/* harmony import */ var _site_main__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./site/main */ \"./client/public/js/site/main.js\");\n\n\n\n\n//# sourceURL=webpack:///./client/public/js/index.js?");
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _editor_project__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../editor/project */ \"./client/public/js/editor/project.js\");\n\n\n\nconst APP = angular.module('app', []);\n\nAPP.controller('main', function() {\n\tthis.stages = [{\n\t\tname: 'canvas-1',\n\t\tdisplayed: true\n\t}]\n\n\n\tthis.toggleLayer = (canvas) => {\n\t\tlet el = document.getElementById(canvas),\n\t\t\tdisplay = el.style.display,\n\t\t\tshow = display === 'block' || !display ? 'none' : 'block';\n\n\t\tel.style.display = show;\n\n\t\tthis.stages.forEach(v => {\n\t\t\tif(v.name === canvas){\n\t\t\t\tv.displayed = show === 'block' ? true : false;\n\t\t\t}\n\t\t})\n\t}\n\n\tthis.createStage = () => {\n\t\tconst stage = _editor_project__WEBPACK_IMPORTED_MODULE_0__[\"default\"].create();\n\n\t\tthis.stages.push({\n\t\t\tname: stage.id,\n\t\t\tdisplayed: true\n\t\t})\n\t}\n});\n\n//# sourceURL=webpack:///./client/public/js/site/main.js?");
